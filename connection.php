...
class  Database{
    ...
    public function formatDate($date)
    {
        ...
        public function userRegistration($data)
        {
            ...
            }elseif ($checkEmail == TRUE) 
            {
                ...
                $sql = "INSERT INTO users(name, username, email, password, roleid) VALUES(:name, :username, :email, :password, :roleid)";
                $stmt = $this->db->prepare($sql);
    ...
    public function userLoginAuthotication($data)
    {
        ...
        if ($email == "" || $password == "" ) {
            $msg = '<center><div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
                <a href="" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                <strong>Error !</strong> Email or Password not be Empty !</div></center>';
            return $msg;
