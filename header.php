            ...
            <ul class="navbar-nav ml-auto">
                <?php if (Session::get('id') == TRUE) { ?>
                    <?php if (Session::get('roleid') == '1') { ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="documentation.php"><i class="fas fa-users mr-2"></i>documentation </span></a>
                        </li>

                    <?php  }elseif(Session::get('roleid') == '3'){ ?>

                        <li class="nav-item">
                            <a class="nav-link" href="contact.php"><i class="fas fa-users mr-2"></i>contact </span></a>
                        </li>
                ...
                <?php }else{ ?>
                    ...
                    <li class="nav-item
                        ...
                        <a class="nav-link" href="Sign.php"><i class="fas fa-user-plus mr-2"></i>Sign</a>
                    </li>
